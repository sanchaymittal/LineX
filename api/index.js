...
async function createInitializedApp() {
    ...
    if (!app) {
        ...
        try {
            const defiServices = await (0, defi_1.initializeDeFiServices)();
            (0, defi_1.attachDeFiServices)(app, defiServices);
            logger_1.default.info('✅ DeFi services attached to Express app');
        }
        catch (error) {
